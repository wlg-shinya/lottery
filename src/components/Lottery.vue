...
const lotteryTargets = computed(() => inputText.value.split("\n").filter((x) => x));
...
<template>
  <div class="d-flex flex-column align-items-center">
    <FlexTextarea @input="onInputFlexTextarea" :initText="inputText" :placeholder="PLACEHOLDER_TEXT" :disabled="!editable" style="min-width: 250px" />
    <div>
